...
* Abstract: "This cast moved to the Field House’s new location in 2004". Insert "was" before "moved".
* Heading "NTRODUCTION": should be "INTRODUCTION".
* Introduction: "As described by Taylor and others (in preparation)". Here and elsehere, this needs to specify "in preparation, a", since this is also a separate "in preparation, b".
